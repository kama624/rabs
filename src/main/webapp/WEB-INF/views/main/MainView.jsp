...
<head>
    ...
    <!-- Custom CSS -->
    <link href="${pageContext.request.contextPath}/css/dist/sb-admin-2.css" rel="stylesheet">
    ...
    <script src="${pageContext.request.contextPath}/js/dist/sb-admin-2.js"></script>
</head>
        ...
        <!-- Navigation -->
	      ...
	      <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
	            <div class="navbar-header">
	                ...
	                <a class="navbar-brand" href="index.html">RABS</a>
	            </div>
	            <!-- /.navbar-header -->
	<!-- 
